...
<body>
    ...
    <form action="reg1.php" method="post">
        ...
        <div class="form-group">
            <label for="enter email_id">email_id</label>
...
<?php
    ...
    if($_SERVER['REQUEST_METHOD']=='POST'){
        if(isset($_POST['UN1']) &&
            ...
            $insQur1="insert into `reginfo1` values ('$uuNN1','$uuFN1','$uuDOB1','$uuPS1','$uuM1','$uuE1')";
